...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val sleepTrackerViewModel = provider.get(SleepTrackerViewModel::class.java)
        ...
        sleepTrackerViewModel.navigateToSleepQuality.observe(this, Observer { night ->
            night?.let {
                ...
                val directions = SleepTrackerFragmentDirections.actionSleepTrackerFragmentToSleepQualityFragment(night.nightId)
        ...
        sleepTrackerViewModel.navigateToSleepDetail.observe(this, Observer { night ->
            night?.let {
                val directions = SleepTrackerFragmentDirections.actionSleepTrackerFragmentToSleepDetailFragment(night)
                this.findNavController().navigate(directions)
        ...
        manager.spanSizeLookup = object : GridLayoutManager.SpanSizeLookup() {
            // return the right span size for each position
            override fun getSpanSize(position: Int) =  when (position) {
                // Position 0 has a span size of 3
                0 -> 3
                // the other positions have a span size of 1
                else -> 1
            }
        }
